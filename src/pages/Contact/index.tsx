                ...
                <Container maxWidth="lg" sx={{
                    ...
                    <Stack flexDirection='row' flexWrap='wrap' textAlign='center' justifyContent='center' p={3} gap={1} >
                        <Stack sx={{
                            ...
                            <TextField className="input_elem" fullWidth label="Adınız və Soyadınız" variant="outlined" />
                            <TextField className="input_elem" fullWidth label="Email ünvanı" variant="outlined" />
                            <TextField className="input_elem" fullWidth label="Əlaqə nömrəsi" variant="outlined" />
                        </Stack>
                        <Stack sx={{
                            width: '400px',
                            padding: 0
